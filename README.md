jQuery YoutubeVideo Plugin <sup>1.0.0</sup>
-------
_Позволяет встраивать на сайт видеолики с YouTube более простым и оптимальным способом с точки зрения скорости загрузки сайта и адаптивности._
...
* Возможность задавать новые/переопределять опции через data-атрибуты инидивидуально для каждого видео.
...
// Воспроизведение первого ранее инициализированого видео из выборки
